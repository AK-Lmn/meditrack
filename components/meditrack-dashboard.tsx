...
function DashboardView(props: { activeLabel: string; medications: Medication[]; filtered: Medication[]; takenIds: Set<number>; todayTaken: number; pendingDoseId: number | null; query: string; setQuery: (value: string) => void; setShowAdd: (value: boolean) => void; toggleDose: (id: number) => void; archive: (medicine: Medication) => void }) {
  const { activeLabel, medications, filtered, takenIds, todayTaken, pendingDoseId, query, setQuery, setShowAdd, toggleDose, archive } = props
